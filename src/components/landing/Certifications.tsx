...
const certifications = [{
  name: "HMDA Approved",
  description: "Fully Sanctioned Layout"
}, {
  name: "RERA Registered",
  description: "Absolute Peace of Mind"
}, {
  name: "Clear Title",
  description: "100% Clear Titles With Spot Registration"
}, {
  name: "Bank Approved",
  description: "Pre-approved by Leading Banks"
}];
const Certifications = () => {
  return <section className="py-16 md:py-20 bg-background relative overflow-hidden">
      {/* Nature SVG Background - Eucalyptus Branch */}
      <svg className="absolute top-0 left-0 w-72 h-72 opacity-[0.05] text-accent" viewBox="0 0 200 200" fill="currentColor">
      ...
      <svg className="absolute bottom-0 right-0 w-64 h-64 opacity-[0.04] text-primary rotate-180" viewBox="0 0 200 200" fill="currentColor">
        <ellipse cx="30" cy="50" rx="15" ry="25" transform="rotate(-30 30 50)" />
        <ellipse cx="50" cy="80" rx="12" ry="20" transform="rotate(-45 50 80)" />
        <ellipse cx="70" cy="110" rx="15" ry="25" transform="rotate(-30 70 110)" />
      </svg>
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 max-w-5xl mx-auto">
          {certifications.map((cert, index) => <div key={index} className="flex flex-col items-center text-center gap-3 bg-soft-gray px-4 py-6 rounded-xl border border-border/50">
